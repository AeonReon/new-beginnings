...
window.WONDERS = [
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"Good morning, sun. First one up gets the whole day.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"There are people in that. Wave.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"The Merry Dancers are out. Get your coat.",
    by:'Traditional Ulster and Scots name — Na Fir Chlis, the nimble men',
  ...
  },
  {
    ...
    words:"What's that one? I see a — no, wait, look at it now.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Hello again, Orion. Same three stars, same as last year.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Good morning, robin. Thanks for the company.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Welcome home. You came a long way for this.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"They're back. Same pond, same week, every year.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Once a year', months:[2,3,4],
    words:"First lamb of the year! That's the winter over.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Most weeks', months:'any',
    words:"Whose was this, then? Let's work it out.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"He came up to look at us. Look back.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Listen. Don't look yet — listen first.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"She's working. We'll not bother her.",
    by:'Ours',
  ...
  // ══ WHAT THE SKY DOES ══════════════════════════════════════════════════
  {
    ...
    words:"Snow! Coats. Now. Everything else can wait.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Most weeks', months:'any',
    words:"Sun and rain at once — turn your back on the sun and look.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Lean on it. It'll hold you up.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Most weeks', months:'any',
    words:"Smell that? Rain's coming. Two minutes.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"That's the sun on my arms. First time this year.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Rare', months:'any',
    words:"Look at that. Not a breath on it.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"First flower of the year. It came up through the frost.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Catch one before it lands.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"A leaf caught before it lands is a wish. One wish for every leaf.",
    by:'Traditional',
  ...
  },
  {
    ...
    words:"First conker! Open it before anyone else gets here.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Highest thrower wins. Watch it spin.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"First one of the year. You take it.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Now and then', months:'any',
    words:"See the way the field goes round it? Nobody would cut that one.",
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Now and then', months:'any',
    words:"This was here before Granny. Before Granny's granny.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"That's the smell of summer starting.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Rare', months:'any',
    words:"Look through it and say what you can see.",
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"Flat stone, flat water, low and hard. Count them out loud.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Hold it tight, think of the wish, and let it go.",
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Now and then', months:'any',
    words:"Listen. Now put it down and listen again. Still there?",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"All this was under the sea this morning. It'll be back by tea.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Right. Shoes off. On three.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Most weeks', months:'any',
    words:"Two sticks, one each. Over the side, then run to the other side and see whose comes out first.",
    by:'Traditional — Poohsticks',
  ...
  },
  {
    ...
    words:"Make your wish. Don't say it out loud or it won't come.",
    by:'Traditional',
  ...
  },
  {
    ...
    kind:'Wish', rarity:'Now and then', months:'any',
    words:"Little finger each. Hold your wish. Pull.",
    by:'Traditional',
  ...
  },
  {
    ...
    words:"Wait — don't move. Put it on your finger. Wish, and blow.",
    by:'Traditional',
  ...
  },
  {
    ...
    how:"Two words, every single time, without fail, said to everyone including the one nipping out for milk. The value is entirely in it being unbroken. A child should be able to predict it exactly.",
  ...
  },
  {
    ...
    words:"You're home! Now the house is right.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"New shoes. Show me how fast they go.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Blessing', rarity:'Now and then', months:'any',
    words:"Tomorrow's new. You've done new before, and you were grand.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Quick — all the same numbers. Make a wish before it changes.",
  ...
  },
  {
    ...
    words:"Open the back door to let the old year out, and the front to let the new one in.",
    by:'Traditional — Ulster and Scotland',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Once a year', months:[1,2],
    words:"Brigid's day. That's the spring in, whatever the weather says.",
    by:'Traditional — Irish',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Once a year', months:[4,5],
    words:"May morning. Out before the sun's up, and wash your face in the grass.",
    by:'Traditional — Irish and Ulster',
  ...
  },
  {
    ...
    words:"Longest day of the whole year. Nobody goes to bed until it's dark.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"No reason. Just because it's nicer.",
    by:'Ours',
