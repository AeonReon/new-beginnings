...
window.WONDERS = [
  ...
  },
  {
    ...
    words:"Rainbow, rainbow, arched and high,\nrain and sunshine in the sky.\nRed and orange, green and blue —\nname a good thing, one for you.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"Out of bed before the sun,\ncoats on over pyjamas — run.\nNobody's up but us and the birds.\nWatch it come. Don't say a word.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Moon in the morning, pale and thin,\nthe sun came up and you stayed in.\nThey say the moon comes out at night —\nbut there you are, in broad daylight.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"Not a star, and not a plane —\na steady light, and gone again.\nThere's people up there, wide awake.\nWave to them, quick, for their sake.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Rug on the grass, coats on tight,\nthe sky is throwing stars tonight.\nCount them out, wish on each —\nmore of them than you can reach.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Merry Dancers, up tonight,\ngreen and shifting, low and bright.\nThey don't come often. Don't stay in —\ncoats on, out, and let them begin.",
  ...
  },
  {
    ...
    words:"Three stars in a row — look there,\nOrion's back for another year.\nHe'll go away when spring comes round,\nand next year, he'll be found.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Robin, robin, red and bold,\ncome and work with me in the cold.\nStand still long enough, you'll see —\nhe isn't frightened. Not of me.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Same pond, same jelly, same wee dots —\nthe whole of spring in little spots.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Once a year', months:[2,3,4],
    words:"First white lamb upon the green —\nthe winter's over. Winter's been.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Spun in the dark while we're asleep,\nthread over thread, and not a peep.\nThe dew came down and lit it through —\na whole night's work, on show for you.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Nobody move and nobody talk,\nstill as a stone, don't even walk.\nIt hasn't seen us standing here —\nstand very still, and it'll come near.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Listen before you look — you'll hear\nwild wings coming, very near.\nDown from the ice, and here to stay,\ntaking turns the whole long way.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Busy and golden, working away —\nstand still, and let her have the day.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Count from the flash until the sound:\none-and, two-and, three-and, four.\nFive of those means a mile away —\ncount the next one. Near, or more?",
    by:'Ours — the counting method itself is old, and sound',
  ...
  },
  {
    ...
    words:"Lean on the wind and let it hold,\nstrong enough to keep you bold.\nShout as loud as ever you can —\nnobody hears. That's the plan.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Breathe out hard and watch it rise —\nyour own wee cloud before your eyes.\nOnly the cold can make it show.\nDragons come when there's frost below.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Ferns on the window, ferns on glass,\ndrawn by the cold as it went past.\nNobody taught it. Nobody drew.\nPress a thumb — it melts right through.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Fog in the morning, thick and grey,\nthe end of the road has gone away.\nWalk to the edge — it moves as well,\nand where it stops, you'll never tell.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Rare', months:'any',
    words:"Not a wave and not a sound,\nthe whole sea flat as level ground.\nLook down — the sky is lying there,\na second sky, and just as fair.",
    by:'Ours',
  ...
  // ══ GROWING THINGS ═════════════════════════════════════════════════════
  {
    ...
    words:"Dandelion, dandelion, soft and round,\none big blow — you're off the ground.\nTake my wish out over the hill,\nand plant it wherever you will.",
  ...
  },
  {
    ...
    words:"First of the flowers — white and small,\npushing up through frost and all.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Snow that grows upon the tree,\nfalling white and falling free.\nCatch a petal in the air —\nten days only. Then it's bare.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Green and spiky on the ground —\ncrack it open, treasure found.\nShining new and never seen,\nthe brightest brown there's ever been.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Little wings, come spinning down,\nround and round and round.\nThrow them high and watch them go —\nnobody taught them. They just know.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"The blackest one, the first one found,\nstraight to you — the rest go round.\nPick them high, above the dust,\nand mind the thorns. Worth the fuss.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Now and then', months:'any',
    words:"See the field bend round that tree?\nSomebody left it be.",
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Now and then', months:'any',
    words:"Older than Granny and her gran,\nolder than our counting can.\nPut your arms round it, hold on tight —\nit stood here before electric light.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"First cut of the year — there it goes,\nthe smell of summer, up your nose.\nBreathe it in and don't forget:\nthat's the best smell you'll ever get.",
    by:'Ours',
  ...
  // ══ BY THE WATER ═══════════════════════════════════════════════════════
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"There it is — the whole wide sea,\nfurther than your eyes can see.\nFirst to spot it, first to shout —\nthat's what all the drive was about.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Noticing', rarity:'Rare', months:'any',
    words:"Worn by the wind, worn by the sea —\nlook through, and see what you can see.",
    by:'Ours — hag stones and adder stones are old Irish and British custom',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"Flat wee stone and a flat calm sea,\nlow and hard — now let it free.\nOne, two, three, four, five, six, seven —\ncount them out. That last one's heaven.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Shoes off, socks off, count to three,\nin we go — the whole family!\nFreezing toes and don't think twice,\nthe sea in April's cold as ice.",
    by:'Ours',
  ...
  // ══ OUR OWN DAYS ═══════════════════════════════════════════════════════
  {
    ...
    words:"Seven years old, this very day —\nthe morning that you came our way.\nHappy birthday.",
  ...
  },
  {
    ...
    words:"One big breath, and out they go —\nmake your wish, but don't let it show.\nKeep it behind your teeth, hold tight:\nwishes told out loud don't come right.",
  ...
  },
  {
    ...
    kind:'Wish', rarity:'Now and then', months:'any',
    words:"Little fingers, hold on tight —\nbiggest piece gets the wish tonight.",
  ...
  },
  {
    ...
    words:"An eyelash caught upon your cheek —\nput it on your finger. Don't you speak.\nHold the wish and blow it clear,\nand don't tell anybody here.",
  ...
  },
  {
    ...
    by:'Ours — built around the traditional Irish blessing "safe home"',
  ...
  },
  {
    ...
    words:"You're home! Now come in, come in,\nthe house was waiting. Let it begin.\nKettle on and coat on the hook:\nit's a house again. Come and look.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Blessing', rarity:'Now and then', months:'any',
    words:"Tomorrow's new, and that's all right —\nyou've done new things before tonight.\nYou were grand then. You'll be grand.\nNow go to sleep. I'll hold your hand.",
    by:'Ours',
  ...
  },
  {
    ...
    words:"Look — the numbers all agree!\nQuick now, wish, for you and me.\nSixty seconds, then they're through —\nso make it fast, whatever you do.",
    by:'Ours — the custom is modern, spread among children by children',
  ...
  },
  {
    ...
    words:"Out with the old, in with the new,\nopen the doors and let it through.\nCoal for warmth and bread for the year,\nand a coin, so there's plenty here.",
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Once a year', months:[4,5],
    words:"Up before the sun, first of May —\nwash your face in dew. Good day.",
  ...
  },
  {
    ...
    words:"Longest day — the light won't go,\nso stay up late and watch it slow.\nShortest day — the dark comes fast,\nso light a candle. Make it last.",
    by:'Ours',
  ...
  },
  {
    ...
    kind:'Celebration', rarity:'Now and then', months:'any',
    words:"Nothing special, nothing planned,\njust a candle in your hand.\nBig light off, and look — it's true:\nan ordinary night will do.",
    by:'Ours',
